...
enum LegWorkout: String, CaseIterable, Identifiable, Hashable {
    ...
    case overheadSquat = "Overhead Squat", pistolSquats = "Pistol Squats"
    ...
    case walkingLunges = "Walking Lunges",  weightedReverseLunges = "Weighted Reverse Lunges", weightedStepUps = "Weighted Step-ups"
